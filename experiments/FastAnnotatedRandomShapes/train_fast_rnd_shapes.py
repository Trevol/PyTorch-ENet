...
class Args:
    ...
    dataset_ctor = ds
    dataset = 'FastAnnotatedRndShapes'
    dataset_dir = './FastAnnotatedRndShapes/'
    ...
    mode = 'test'
    imshow_batch = False
    weighing = './FastAnnotatedRndShapes/class_weights_ENet.npy'  # 'ENet' 'mfb' './FastAnnotatedRndShapes/class_weights_mfb.npy' './FastAnnotatedRndShapes/class_weights_ENet.npy'
...
def train(args: Args, device, train_loader, val_loader, class_weights, class_encoding):
    ...
    num_classes = len(class_encoding)  # without triangles
...
def load_dataset(args, dataset, device):
    print("\nLoading dataset...\n")
...
def main():
    ...
    model = train(args, device, train_loader, val_loader, w_class, class_encoding)
